...
class User:
    def __init__(self, first_name, last_name, email_address):
        ...
        self.checking_account = BankAccount("checking", 0.02)
        self.saving_account = BankAccount("saving", 0.05)


    def make_deposit(self, amount, whichAccount):
        if whichAccount == "checking":
            self.checking_account.deposit(amount)
        elif whichAccount == "saving":
            self.saving_account.deposit(amount)
        return self

    def make_withdrawal(self, amount, whichAccount):
        if whichAccount == "checking":
    ...
    def display_user_balance(self, whichAccount):
        if whichAccount == "checking":
            print(self.checking_account.display_account_info())
        elif whichAccount == "saving":   
            print(self.saving_account.display_account_info())
        return self

class BankAccount:
    def __init__(self, typeofAccount, int_rate):
...
print(Mutombo.make_deposit(1000, "checking")) # using class User method
print("********************")
print(Mutombo.checking_account.deposit(1000)) # using class BankAccount method
print("********************")
print("********************")
print(Mutombo.make_withdrawal(250, "checking"))
print("********************")
