...
# and traversing through a list of dictionaries or through a dictionary of lists
# Note: Avoid using class keywords like int, str, list, and dict as variable/parameter names.
# Update Values in Dictionaries and Lists

#=================================================================
#1A
# x = [ [5,2,3], [10,8,9] ] is a list of lists
...
# students is an array of dictionaries
...
print(sports_directory)
#solution:
#{'basketball': ['Kobe', 'Jordan', 'James', 'Curry'], 'soccer': ['Messi', 'Ronaldo', 'Rooney']}
